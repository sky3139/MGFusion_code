...
PointCloud::Ptr SaveVoxelGrid2SurfacePointCloudMem(const std::string &file_name, float *voxel_grid_color, int voxel_grid_dim_x, int voxel_grid_dim_y, int voxel_grid_dim_z,
                                                   float voxel_size, float voxel_grid_origin_x, float voxel_grid_origin_y, float voxel_grid_origin_z,
                                                   float *voxel_grid_TSDF, float *voxel_grid_weight,
                                                   float tsdf_thresh, float weight_thresh, pcl::visualization::PCLVisualizer::Ptr viewer)
{
